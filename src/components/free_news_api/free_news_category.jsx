...
import { free_news_category } from "../../api/fetchNewsByCategory";
import { useParams } from "react-router-dom";
import { Link } from "react-router-dom";

export default function FreeNewsByCategory() {
  const { news_category } = useParams();
  const { data, isLoading, isError, error } = useQuery({
    queryKey: ["newCategory", "free_news", news_category],
    queryFn: () => free_news_category(news_category),
  });
  if (isLoading) {
